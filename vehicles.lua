...
local Vehicles = {
    ...
    { model = 'asterope2',     name = 'Asterope2',                     brand = 'Karin',           price = 11000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'impaler5',      name = 'impaler5',                      brand = 'Declasse',        price = 12000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'baller8',       name = 'Baller',                        brand = 'Gallivanter',     price = 14500,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'dorado',        name = 'dorado',                        brand = 'Bravado',         price = 10000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'vivanite',      name = 'vivanite',                      brand = 'Karin',           price = 15000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    ...
    { model = 'cavalcade3',    name = 'Cavalcade III',                 brand = 'Albany',          price = 16500,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    ...
    { model = 'aleutian',      name = 'aleutian',                      brand = 'Vapid',           price = 16000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    --- Coupes (3)
    ...
    { model = 'driftfr36',      name = 'Driftfr36',                    brand = 'FATHOM',          price = 20000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'fr36',      name = 'fr36',                              brand = 'FATHOM',          price = 10000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    --- Muscle (4)
    ...
    { model = 'impaler6',      name = 'impaler6',                      brand = 'Declasse',        price = 5000,    category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'dominator9',    name = 'Dominator9',                    brand = 'Vapid',           price = 62500,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'driftyosemite', name = 'driftyosemite',                 brand = 'Declasse',        price = 19500,   category = 'muscle',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'driftjester',   name = 'driftjester',                   brand = 'Dinka',           price = 240000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    ...
    { model = 'driftfuto',     name = 'driftfuto',                     brand = 'Karin',           price = 17500,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'drifteuros',    name = 'drifteuros',                    brand = 'Annis',           price = 38000,   category = 'sports',         type = 'automobile', shop = 'luxury' },
    { model = 'drifttampa',    name = 'drifttampa',                    brand = 'Declasse',        price = 80000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'driftzr350',    name = 'driftzr350',                    brand = 'Annis',           price = 56000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    { model = 'driftremus',    name = 'driftremus',                    brand = 'Annis',           price = 54000,   category = 'sports',         type = 'automobile', shop = 'pdm' },
    --- Super (7)
    ...
    { model = 'turismo3',      name = 'turismo3',                      brand = 'Grotti',          price = 170000,  category = 'super',          type = 'automobile', shop = 'pdm' },
    --- Motorcycles (8)
    ...
    { model = 'terminus',      name = 'terminus',                      brand = 'Canis',           price = 25000,   category = 'offroad',        type = 'automobile', shop = 'pdm' },
    ...
    { model = 'towtruck4',      name = 'Tow Truck (Large)',             brand = 'Vapid',           price = 30000,   category = 'utility',        type = 'automobile', shop = 'truck' },
    { model = 'towtruck3',      name = 'Tow Truck (Large)',             brand = 'Vapid',           price = 30000,   category = 'utility',        type = 'automobile', shop = 'truck' },
    ...
    { model = 'boxville5',     name = 'Armored Boxville',              brand = 'Brute',           price = 45000,   category = 'vans',           type = 'automobile', shop = 'truck' },
    { model = 'boxville6',     name = 'Boxville LSDWP',                brand = 'Brute',           price = 45000,   category = 'vans',           type = 'automobile', shop = 'truck' },
    ...
    --- Boats (14)
    { model = 'dinghy4',       name = 'Weaponized Dinghy',             brand = 'Nagasaki',        price = 40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'avisa',         name = 'Avisa',                         brand = 'Kraken Subs',     price = 40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'patrolboat',    name = 'Kurtz 31 Patrol Boat',          brand = 'Unknown',         price = 40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'longfin',       name = 'Longfin',                       brand = 'Shitzu',          price = 40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    { model = 'tug',           name = 'Tug',                           brand = 'Buckingham',      price = 40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    ...
    { model = 'submersible2',  name = 'Kraken',                        brand = 'Kraken Subs',     price = 40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    ...
    { model = 'submersible',   name = 'Submersible',                   brand = 'Kraken Subs',     price = 40000,   category = 'boats',          type = 'boat',       shop = 'boats' },
    ...
    --- Helicopters (15)
    { model = 'conada2',       name = 'Weaponized Conada',             brand = 'Buckingham',      price = 52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    ...
    { model = 'annihilator2',  name = 'Annihilator Stealth',           brand = 'Western Company', price = 52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'seasparrow',    name = 'Sea Sparrow',                   brand = 'Unknown',         price = 52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'akula',         name = 'Akula',                         brand = 'Unknown',         price = 52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'hunter',        name = 'FH-1 Hunter',                   brand = 'Unknown',         price = 52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    ...
    { model = 'valkyrie',      name = 'Valkyrie',                      brand = 'Buckingham',      price = 52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'savage',        name = 'Savage',                        brand = 'Unknown',         price = 52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'swift',         name = 'Swift',                         brand = 'Buckingham',      price = 52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'annihilator',   name = 'Annihilator',                   brand = 'Western Company', price = 52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'cargobob2',     name = 'Cargobob Jetsam',               brand = 'Western Company', price = 52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'skylift',       name = 'Skylift',                       brand = 'HVY',             price = 52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    ...
    { model = 'cargobob',      name = 'Cargobob',                      brand = 'Western Company', price = 52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'cargobob3',     name = 'Cargobob',                      brand = 'Western Company', price = 52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'seasparrow3',   name = 'Sparrow (Prop)',                brand = 'Unknown',         price = 52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'buzzard',       name = 'Buzzard Attack Chopper',        brand = 'Nagasaki',        price = 52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    { model = 'buzzard2',      name = 'Buzzard',                       brand = 'Nagasaki',        price = 52000,   category = 'helicopters',    type = 'heli',       shop = 'air' },
    --- Planes (16)
    { model = 'streamer216',   name = 'Streamer216',                   brand = 'Mammoth',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'raiju',         name = 'F-160 Raiju',                   brand = 'Mammoth',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'alkonost',      name = 'RO-86 Alkonost',                brand = 'Unknown',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'strikeforce',   name = 'B-11 Strikeforce',              brand = 'Unknown',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'blimp3',        name = 'Blimp',                         brand = 'Unknown',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'avenger',       name = 'Avenger',                       brand = 'Mammoth',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'avenger2',      name = 'Avenger',                       brand = 'Mammoth',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'avenger3',      name = 'Avenger',                       brand = 'Mammoth',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'avenger4',      name = 'Avenger',                       brand = 'Mammoth',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },    
    { model = 'volatol',       name = 'Volatol',                       brand = 'Unknown',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'nokota',        name = 'P-45 Nokota',                   brand = 'Unknown',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'seabreeze',     name = 'Seabreeze',                     brand = 'Western Company', price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'pyro',          name = 'Pyro',                          brand = 'Buckingham',      price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'mogul',         name = 'Mogul',                         brand = 'Mammoth',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'howard',        name = 'Howard NX-25',                  brand = 'Unknown',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'bombushka',     name = 'RM-10 Bombushka',               brand = 'Unknown',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'molotok',       name = 'V-65 Molotok',                  brand = 'Unknown',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'microlight',    name = 'Ultralight',                    brand = 'Unknown',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'tula',          name = 'Tula',                          brand = 'Mammoth',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'rogue',         name = 'Rogue',                         brand = 'Western Company', price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'starling',      name = 'LF-22 Starling',                brand = 'Unknown',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'alphaz1',       name = 'Alpha-Z1',                      brand = 'Buckingham',      price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    ...
    { model = 'hydra',         name = 'Hydra',                         brand = 'Mammoth',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'blimp2',        name = 'Xero Blimp',                    brand = 'Unknown',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    ...
    { model = 'besra',         name = 'Besra',                         brand = 'Western Company', price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    ...
    { model = 'titan',         name = 'Titan',                         brand = 'Unknown',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'shamal',        name = 'Shamal',                        brand = 'Buckingham',      price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    { model = 'lazer',         name = 'P-996 Lazer',                   brand = 'JoBuilt',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    ...
    { model = 'jet',           name = 'Jet',                           brand = 'Unknown',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    ...
    { model = 'blimp',         name = 'Atomic Blimp',                  brand = 'Unknown',         price = 45000,   category = 'planes',         type = 'plane',      shop = 'air' },
    --- Service (17)
    { model = 'brickade',      name = 'Brickade',                      brand = 'MTL',             price = 100000,  category = 'service',        type = 'automobile', shop = 'truck' },
    { model = 'brickade2',     name = 'Brickade 6x6',                  brand = 'MTL',             price = 100000,  category = 'service',        type = 'automobile', shop = 'truck' },
    { model = 'pbus2',         name = 'Festival Bus',                  brand = 'Unknown',         price = 100000,  category = 'service',        type = 'automobile', shop = 'truck' },
    { model = 'wastelander',   name = 'Wastelander',                   brand = 'MTL',             price = 100000,  category = 'service',        type = 'automobile', shop = 'truck' },
    { model = 'rallytruck',    name = 'Dune',                          brand = 'MTL',             price = 100000,  category = 'service',        type = 'automobile', shop = 'truck' },
    ...
    { model = 'freight2',       name = 'Freight Train',                brand = 'Unknown',         price = 100000,  category = 'service',        type = 'automobile', shop = 'none' },
    { model = 'cablecar',      name = 'Cable Car',                     brand = 'Unknown',         price = 100000,  category = 'service',        type = 'automobile', shop = 'none' },
    { model = 'trash',         name = 'Trashmaster',                   brand = 'JoBuilt',         price = 100000,  category = 'service',        type = 'automobile', shop = 'truck' },
    { model = 'trash2',        name = 'Trashmaster',                   brand = 'JoBuilt',         price = 100000,  category = 'service',        type = 'automobile', shop = 'truck' },
    { model = 'tourbus',       name = 'Tour Bus',                      brand = 'Brute',           price = 100000,  category = 'service',        type = 'automobile', shop = 'truck' },
    { model = 'taxi',          name = 'Taxi',                          brand = 'Vapid',           price = 100000,  category = 'service',        type = 'automobile', shop = 'pdm' },
    { model = 'rentalbus',     name = 'Rental Shuttle Bus',            brand = 'Brute',           price = 100000,  category = 'service',        type = 'automobile', shop = 'truck' },
    { model = 'coach',         name = 'Dashound',                      brand = 'Brute',           price = 100000,  category = 'service',        type = 'automobile', shop = 'truck' },
    { model = 'bus',           name = 'Bus',                           brand = 'Brute',           price = 100000,  category = 'service',        type = 'automobile', shop = 'truck' },
    { model = 'airbus',        name = 'Airport Bus',                   brand = 'Brute',           price = 100000,  category = 'service',        type = 'automobile', shop = 'truck' },
    --- Emergency (18)
    { model = 'riot',          name = 'Police Riot',                   brand = 'Brute',           price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'riot2',         name = 'RCV',                           brand = 'Unknown',         price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'pbus',          name = 'Police Prison Bus',             brand = 'Vapid',           price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'police',        name = 'Police Cruiser',                brand = 'Vapid',           price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'police2',       name = 'Police Buffalo',                brand = 'Vapid',           price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'police3',       name = 'Police Interceptor',            brand = 'Vapid',           price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'police4',       name = 'Unmarked Cruiser',              brand = 'Vapid',           price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'sheriff',       name = 'Sheriff SUV',                   brand = 'Declasse',        price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'sheriff2',      name = 'Sheriff Cruiser',               brand = 'Vapid',           price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'policeold1',    name = 'Police Rancher',                brand = 'Declasse',        price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'policeold2',    name = 'Police Roadcruiser',            brand = 'Albany',          price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'policet',       name = 'Police Transporter',            brand = 'Vapid',           price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'policeb',       name = 'Police Bike',                   brand = 'Vapid',           price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'police5',       name = 'Police Cruiser New',            brand = 'Vapid',           price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'polgauntlet',   name = 'Police Gauntlet New',           brand = 'Bravado',         price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' }, 
    { model = 'polmav',        name = 'Police Maverick',               brand = 'Buckingham',      price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'ambulance',     name = 'Ambulance',                     brand = 'Brute',           price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'firetruk',      name = 'Fire Truck',                    brand = 'MTL',             price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'lguard',        name = 'Lifeguard',                     brand = 'Declasse',        price = 5000,  category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'seashark2',     name = 'Seashark Lifeguard',            brand = 'Speedophile',     price = 5000,   category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'pranger',       name = 'Park Ranger',                   brand = 'Declasse',        price = 5000,   category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'fbi',           name = 'FIB Buffalo',                   brand = 'Bravado',         price = 5000,   category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'fbi2',          name = 'FIB Granger',                   brand = 'Declasse',        price = 5000,   category = 'emergency',      type = 'automobile', shop = 'emergency' },
    { model = 'predator',      name = 'Police Predator',               brand = 'Unknown',         price = 5000,   category = 'emergency',      type = 'automobile', shop = 'emergency' },
    --- Military (19)
    ...
    { model = 'crusader',      name = 'Crusader',                      brand = 'Canis',           price = 100000,  category = 'military',       type = 'automobile', shop = 'pdm' },
    { model = 'barracks',      name = 'Barracks',                      brand = 'HVY',             price = 100000,  category = 'military',       type = 'automobile', shop = 'truck' },
    { model = 'barracks2',     name = 'Barracks Semi',                 brand = 'HVY',             price = 100000,  category = 'military',       type = 'automobile', shop = 'truck' },
    { model = 'barracks3',     name = 'Barracks',                      brand = 'HVY',             price = 100000,  category = 'military',       type = 'automobile', shop = 'truck' },
    --- Commercial (20)
    { model = 'cerberus',      name = 'Apocalypse Cerberus',           brand = 'MTL',             price = 100000,  category = 'commercial',     type = 'automobile', shop = 'truck' },
    ...
    { model = 'phantom2',      name = 'Phantom Wedge',                 brand = 'Jobuilt',         price = 100000,  category = 'commercial',     type = 'automobile', shop = 'truck' },
    ...
    { model = 'phantom4',      name = 'Phantom',                       brand = 'Jobuilt',         price = 100000,  category = 'commercial',     type = 'automobile', shop = 'truck' },
    ...
    { model = 'benson2',       name = 'Benson2',                       brand = 'Vapid',           price = 55000,   category = 'commercial',     type = 'automobile', shop = 'truck' },
    --- Trains (21)
    --- Open Wheel (22)
